                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <ol class="breadcrumb migalhas">
                              <li><a href="<?php echo base_url(); ?>index.php/controller/cursos">Cursos</a></li>
                              <li class="active">Mangá</li>
                            </ol>
                          </div>  
                        </div>

                        <div class="inner cover">
                          <div class="page-header"><h1>Mangá</h1></div>
                          ...
                          <main>
                            ...
                            <br><br><br>
                              <p>Mangá é o nome dado às histórias em quadrinhos de origem japonesa, são iguais aos quadrinhos brasileiros, por exemplo, porém com características específicas, geralmente preto e branco, com histórias de fantasia.</p>

                              <h3>Materiais</h3>
                                <p>O Mangá não possui muitos materiais, porém, como qualquer tipo de arte, há materiais específicos para a sua criação, como lápis para a criação de esboços, borracha, caneta nankin e papel específico para maior absorção das canetas.
                                </p>
                                  
                                <h3>Professor</h3>
                                  <img alt="Damian Hirst" src="<?php echo base_url();?>Static/img/damian_hirst2.png" class="img-rounded" />
                                    <h4>
                                      Damian Hirst
                                    </h4>
